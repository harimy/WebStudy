...
<!-- 
   ※ 요청한 페이지의 결과를 확인한 후 새로고침(F5)을 반복해보면
     ...
     - 경로
       맥 → /Users/harim/WebStudy/.metadata/.plugins/org.eclipse.wst.server.core/tmp0/work/Catalina/localhost/WebApp04/org/apache/jsp
        
       윈 → C:\WebStudy\.metadata\.plugins\org.eclipse.wst.server.core
             ----------
              workspace
     ...
     ==> 변수 a 는 클래스(JspTest003_jsp)의 전역 변수로
         ...
         변수 b 는 메소드(JspTest003_jsp 클래스의 _jspServiec()) 내의

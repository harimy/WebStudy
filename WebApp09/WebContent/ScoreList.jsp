		...
		<table class="table">
			...
			<tr>
				...
				<td>
					...
					<span class="errMsg" id="korMsg">0에서 100 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
			<tr>
				<th>영어점수</th>
				<td>
					...
					<span class="errMsg" id="engMsg">0에서 100 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
			<tr>
				<th>수학점수</th>
				<td>
					...
					<span class="errMsg" id="matMsg">0에서 100 사이의 정수를 입력해야 합니다.</span>
				</td>
			</tr>
			<tr>

...
// 학습을 마친 후에 꼭 추가적으로 개념을 정리하고 확장시키고,
// 다른 방법들도 찾아보고 공부해야 한다.
...
public class MyUtil
{
	...
	public String pageIndexList(int currentPage, int totalPage, String listUrl)
	{
		...
		int numPerBlock = 10;
		//-- 페이징 처리 시 게시물 리스트 하단의 숫자를 10개씩 보여주었다.
		...
		*/
		...
		//   『 20 / 10 = 0 』 이며, 여기에 『 *10 』 (10을 곱하면) 20이 되는데
		...
		//-- 『 +1 』 하는 이유는
		//   앞에서 구성한 바와 같이 currentPageSetup 에서 10을 가져왔다면
		//   10부터 시작하는 것이 아니라
